/* SB code provided in source file */
...
class StoryList {
  ...
  static async getStories() {
    ...
    /* The response is an array of objects. Each object represents a story.
    .map is used to iterate over each element and for each element we apply the function
    new Story(story) which takes each element and creates a new instance of the story class */
...
//Completed remove story function:
...
//NOTE: When I added this code, I am able to favorite a story but NOT able to unfavorite it.

/* CODE FROM SB SOLUTION */
//Method added for favorite story/adding favorite story
